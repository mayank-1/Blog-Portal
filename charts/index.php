	...
	<nav class="navbar navbar-inverse">
		...
		<ul class="nav navbar-nav">
			...
			<li><a href="../index.php">Home</a></li>
	     	...
	     	<li class="active"><a id="s_d">Daily</a></li>
...
<?php
	...
	$sql="SELECT * FROM news WHERE category='daily' ORDER BY id DESC LIMIT $page1,10"; //Edited line
	...
	$sql="SELECT * FROM news WHERE category='daily'";
