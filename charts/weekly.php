	...
	<nav class="navbar navbar-inverse">
		...
		<ul class="nav navbar-nav">
			<li><a href="../index.php">Home</a></li>
	      	...
	      	<li class="active"><a id="s_w">Weekly</a></li>
...
<?php
	...
	$post_list="";
	$sql="SELECT * FROM news WHERE category='weekly' ORDER BY id DESC LIMIT $page1,10"; //Edited line
	...
	$sql="SELECT * FROM news WHERE category='weekly'";
