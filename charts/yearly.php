	...
	<nav class="navbar navbar-inverse">
		...
		<ul class="nav navbar-nav">
			<li><a href="../index.php">Home</a></li>
	      	<li class="active"><a id="s_d" href="index.php">Daily</a></li>
	      	<li><a id="s_w" href="weekly.php">Weekly</a></li>
	      	<li><a id="s_q" href="quaterly.php">Quaterly</a></li>
	      	<li class="active"><a id="s_y">Yearly</a></li>
	    </ul>
...
<?php
	...
	$post_list="";
	$sql="SELECT * FROM news WHERE category='yearly' ORDER BY id DESC LIMIT $page1,10"; //Edited line
	...
	$sql="SELECT * FROM news WHERE category='yearly'";
